...
def main():
    ...
    grids_h = drv.mem_alloc(1) #drv.mem_alloc(GenomeDim*DimGridX*DimGridY) #TEST
    ...
    Kernel(dest_h, fitness_h, grids_h, curand_h, block=(32*BankSize,1,1), grid=(BlockDimX,BlockDimY))
