...
__global__ void SearchSpaceKernel(unsigned char *g_ucGenomes,  unsigned char *g_ucGrids, int *g_ucFitnessSize, int *g_ucFitnessHash,  curandState *states)
{
    __shared__ xGenomeSet s_xGenomeSet;
    //__shared__ xEdgeSort s_xEdgeSort;
    __shared__ xAssembly s_xAssembly;
    ...
    s_xGenomeSet.data.multi_d[r_xThreadInfo.BankId()].data.one_d[0] = 41; // 40; //41; //132; // 40; //33;//4; //33; //40
    s_xGenomeSet.data.multi_d[r_xThreadInfo.BankId()].data.one_d[1] = 192; //0; //192; //6; //162; //160 //128; //0;//32;//16;
