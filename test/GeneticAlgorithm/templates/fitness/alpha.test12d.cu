...
*/
    ...
    */
    ...
    convy.shorty = r_xThreadInfo.FlatBlockId()*mWarpSize + r_xThreadInfo.BankId();
    s_xGenomeSet.data.multi_d[r_xThreadInfo.BankId()].data.one_d[0] = convy.charty[0];//r_xThreadInfo.FlatBlockId()*mWarpSize + r_xThreadInfo.BankId();
    s_xGenomeSet.data.multi_d[r_xThreadInfo.BankId()].data.one_d[1] = convy.charty[1];//0;//192; //0; //192; //6; //162; //160 //128; //0;//32;//16;
    s_xGenomeSet.data.multi_d[r_xThreadInfo.BankId()].data.one_d[2] = 0; //2; //138; //138;
    s_xGenomeSet.data.multi_d[r_xThreadInfo.BankId()].data.one_d[3] = 0;
